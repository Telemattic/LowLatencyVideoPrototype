...
encoder: encoder.o v4l2util.o v4l2device.o
	g++ $^ $(CFLAGS) -o $@ $(LDFLAGS)

encoder_h264: encoder_h264.o v4l2util.o v4l2device.o
	g++ $^ -o $@ $(LDFLAGS)

encoder_udp: encoder_udp.o v4l2util.o v4l2device.o
	g++ $^ -o $@ $(LDFLAGS)

v4l2_enumerate: v4l2_enumerate.o v4l2util.o v4l2device.o
	g++ $^ -o $@ $(LDFLAGS)
